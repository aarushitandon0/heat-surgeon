...
Named places (display only): OSM elements carrying a `name` and one of `amenity`, `shop`, `office`, `tourism`, `leisure` or `historic` in each street's 2 km window, © OpenStreetMap contributors, ODbL 1.0. Pulled 2026-09-14 via the Overpass API with `out center tags`. Database timestamps: FC Road and Bajirao Road 2026-09-14T14:40:02Z, North Main Road 2026-09-14T14:46:06Z (overpass-api.de); Karve Road 2026-05-31T22:37:44Z (the overpass.kumi.systems mirror, after the main instance timed out).
