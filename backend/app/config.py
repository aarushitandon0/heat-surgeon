...
# Named buildings and places sent as label candidates. Each map shows only a few after collision; this only bounds
# the payload (a 2 km window in central Pune holds a few hundred named places).
BASEMAP_NAMED_FEATURES_MAX = 1000
